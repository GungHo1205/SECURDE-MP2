...
public class Frame extends javax.swing.JFrame {
    ...
    private void adminBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adminBtnActionPerformed
        ...
        main.sqlite.addLogs("NOTICE", user.getUsername(), user.getUsername() + " accessed admin page", new Timestamp(new Date().getTime()).toString());
    ...
    private void managerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_managerBtnActionPerformed
        ...
        main.sqlite.addLogs("NOTICE", user.getUsername(), user.getUsername() + " accessed manager page", new Timestamp(new Date().getTime()).toString());
    ...
    private void staffBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_staffBtnActionPerformed
        ...
        main.sqlite.addLogs("NOTICE", user.getUsername(), user.getUsername() + " accessed staff page", new Timestamp(new Date().getTime()).toString());
    ...
    private void clientBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clientBtnActionPerformed
        ...
        main.sqlite.addLogs("NOTICE", user.getUsername(), user.getUsername() + " accessed client page", new Timestamp(new Date().getTime()).toString());
    ...
    public void init(Main controller) {
        ...
        adminHomePnl.init(main.sqlite, main);
        clientHomePnl.init(main.sqlite, main);
        managerHomePnl.init(main.sqlite, main);
        staffHomePnl.init(main.sqlite, main);
...
//        main.sqlite.addUser(username, password);
        if (password.equals(confpass)) {
            if (main.addUser(username, password + "")) {
                loginNav();
                JOptionPane.showMessageDialog(null, main.getError("SUCCESS0")); // registration success
                main.sqlite.addLogs("NOTICE", username, username + " registered", new Timestamp(new Date().getTime()).toString());
                ...
                main.sqlite.addLogs("ERROR", username, username + " tried to register encountered ERROR0 ", new Timestamp(new Date().getTime()).toString());
            } else {
                JOptionPane.showMessageDialog(null, main.getError("ERROR1"), "Error", JOptionPane.ERROR_MESSAGE); // invalid input
                main.sqlite.addLogs("ERROR", username, username + " tried to register encountered ERROR1 ", new Timestamp(new Date().getTime()).toString());

            }
        } else {
            JOptionPane.showMessageDialog(null, main.getError("ERROR2"), "Error", JOptionPane.ERROR_MESSAGE); // does not match
            main.sqlite.addLogs("ERROR", username, username + " tried to register encountered ERROR2 ", new Timestamp(new Date().getTime()).toString());
